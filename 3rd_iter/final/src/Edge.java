...
class Edge {
    ...
    public Graph.Vertex go(Graph.Vertex preV, boolean isFurther) {
        if(isFurther) this.setResearchingNow(); //  помечаем текущее ребро как просматриваемое сейчас
        else this.unsetResearchingNow();
    ...
    public boolean getIsResearchingNow(){return isResearchingNow;};
    public Graph.LeftVertex getLeftVertex(){
        return this.leftV;
    }
    public Graph.RightVertex getRightVertex(){
        return this.rightV;
    }
}
